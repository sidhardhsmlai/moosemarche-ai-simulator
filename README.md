...
2.  Consumer Logic (The Marketplace):
    ...
    * Context Guard: Distinguishes between "Ad Price" (B2B) and "Service Rates" (B2C).
...
* Knowledge Base: Text Retrieval (brand_data.txt)

## How to Run Locally
1.  Clone the repository.
2.  Install requirements: pip install -r requirements.txt
3.  Run the engine: streamlit run app.py
